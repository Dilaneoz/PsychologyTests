//
//  BipolarResultViewController.swift
...
class BipolarResultViewController: UIViewController, GADFullScreenContentDelegate
{
    ...
    private func createAd() {
        ...
        GADInterstitialAd.load(withAdUnitID:"ca-app-pub-2179352615092602/5053140534",
                                    request: request,
